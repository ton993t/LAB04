...
*/
#define EXAMPLE_ESP_WIFI_SSID      "TPLINKC54_2.4G"
#define EXAMPLE_ESP_WIFI_PASS      "510401##"
#define EXAMPLE_ESP_MAXIMUM_RETRY  5

#define MQTT_HOST   "mqtt://mqtt.flespi.io"
#define MQTT_PORT   1883
#define MQTT_USER   "amW0v62B8MNFOrqZlJqHjCvzL64ywqSuADlVzbmwOYZqfffrOvYXVhnwdfVxtBQU"
#define MQTT_CLIENTID "LAB4"
...
static const uint16_t INPUT              = 0xFF01;
...
static const uint8_t char1_name[]  = "Input";
...
static const char char_value[30] = "Lab4 test";
...
static const esp_gatts_attr_db_t gatt_db[HRS_IDX_NB] =
{
    ...
    [IDX_CHAR_VAL_A] =
    {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&INPUT, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE | ESP_GATT_PERM_READ_ENC_MITM,
      50, sizeof(char_value), (uint8_t *)char_value}},
        ...
        case ESP_GATTS_WRITE_EVT:
            if (!param->write.is_prep){
                ...
                if(gatt_db_handle_table[IDX_CHAR_VAL_A] == param->write.handle /*&& param->write.len == 4*/) {
                    int msg_id = esp_mqtt_client_publish(client, "ESP32 SmartPhone", (char*)param->write.value, (int)param->write.len, 1, 0);
...
static void mqtt_event_handler(void *handler_args, esp_event_base_t base, int32_t event_id, void *event_data)
{
    ...
    case MQTT_EVENT_CONNECTED:
        ...
        msg_id = esp_mqtt_client_subscribe(client, "ESP32 Laptop", 1);
